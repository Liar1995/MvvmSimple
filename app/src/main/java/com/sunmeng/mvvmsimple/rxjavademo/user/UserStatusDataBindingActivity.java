package com.sunmeng.mvvmsimple.rxjavademo.user;
...
public class UserStatusDataBindingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_databinding_status);
        initView();
        initData();
        initEvent();
    }
